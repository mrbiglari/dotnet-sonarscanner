...
:: Call helper script to list all test project DLLs
call :list_test_dlls
...
MSBuild.exe /t:Rebuild /p:Configuration=Release /p:WarningLevel=0 /p:TreatWarningsAsErrors=false /p:NoWarn=all /v:m /clp:ErrorsOnly
